...
;  'mmo' : Mount Megantic Observatory (Quebec, Canada)
;  'par' : Cerro Paranal, ESO (Chile)
...
;    Added Mount Megantic Observatory  Jonathan Gagne        Oct 2011
;-
...
obs=[ 'kpno','ctio','eso','lick','mmto','cfht','lapalma','mso','sso','aao', $
  ...
  'bosque','rozhen','irtf','bgsuo','ca','holi','lmo','fmo','whitin','mgio','mmo','par']
...
"soar": begin
  name = "Soar Telescope (Cerro Pachon)"
  longitude = 70.7336
  latitude = -30.2381
  altitude = 2738.
  tz = 4
...
"dao":  begin
 ...
 "mmo": begin
  name = "Mount Megantic Observatory"
  longitude = [04,44,36.8]*15.
  latitude = [45,27,18]
  altitude = 1114.
  tz = 5
        end
  "vlt": begin
  name = "Very Large Telescope (ESO)"
  longitude = [70,24,11.642]
  latitude = [-24,37,33.117]
  altitude = 2635.43
  tz = -4
        end
  "par": begin
  name = "Cerro Paranal (ESO)"
  longitude = [70,24,15]
  latitude = [-24,37,38]
  altitude = 2635
  tz = -4
