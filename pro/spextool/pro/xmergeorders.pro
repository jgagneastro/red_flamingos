...
fbmax = weighted_median((*state.d.bluespec)[zb,1], medval=.95)
fbmin = weighted_median((*state.d.bluespec)[zb,1], medval=.05)
fymax = weighted_median((*state.d.greenspec)[zg,1], medval=.95)
fymin = weighted_median((*state.d.greenspec)[zg,1], medval=.05)
...
match,*state.r.orders,*state.r.mergedorders,idxa,idxb,/NOWARN
...
;  Screw thing for missing orders
    ...
    match,*state.r.mergedorders,*state.r.orders,midx,oidx, /NOWARN
      ...
      col1_base = widget_base(row_base,$
         ...
         box1_base = widget_base(col1_base,$
            ...
            row = widget_base(box1_base,$
               ...
               if keyword_set(science_input) then inputsci = file_basename(science_input)
