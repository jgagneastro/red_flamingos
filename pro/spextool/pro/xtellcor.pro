...
;  Construct the kernels for each order
    ...
    case state.d.slitw_arc of 
        ...
        0.72: parms = [0.0,2.32887,0.741824] ;For Flamingos-2
        
        1.0: parms = [0.0,3.23462,0.759592] ;For OSIRIS
    ...
    endcase
;    parms = [[0.0,0.969822,0.768373],[0.0,1.60602,0.714163],[0.0,2.59172,0.751883],[0.0,5.16330,0.782718],[0.0,9.63019,0.834605]]
;    slitw = [.3,.5,.8,1.6,3.0]
;    print, interpol(parms[1,*],slitw,.72)
;    print, interpol(parms[2,*],slitw,.72)
...
readspec,obj,obj,objhdr,objobsmode,start,stop,objnorders,objnaps,objorders,$
         ...
         objairmass
;std[*,1,0] = interpol(std[*,1,0],std[*,0,0],std[*,0,0]+(2.16764-2.166),/nan)
;obj[*,1,0] = interpol(obj[*,1,0],obj[*,0,0],obj[*,0,0]+(2.16764-2.166),/nan)
;std[*,1,1] = interpol(std[*,1,1],std[*,0,1],std[*,0,1]+(1.73557-1.73664),/nan)
;obj[*,1,1] = interpol(obj[*,1,1],obj[*,0,1],obj[*,0,1]+(1.73557-1.73664),/nan)
...
;******************************************************************************
;
pro xtellcor,PATH_INPUT=path_input,SCIENCE_INPUT=science_input,TELL_INPUT=tell_input, BV_INPUT=bv_input, SAVE_INPUT=save_input,IS_IP=is_ip

if ~keyword_set(bv_input) then $
  bv_input = 0.
         ...
         box2_base = widget_base(col1_base,$
            ...
            row = widget_base(box2_base)
               ...
               state.w.box2a_base = widget_base(row,$
                  ...
                  widget_control, state.w.box2a_base,MAP=(1-IS_IP)
